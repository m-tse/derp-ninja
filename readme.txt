...
////////////////
    ...
    MyDFS.java extends DFS.java.  
        DBufferCache buffer cache; //its only connection to the underlying disk		DFileID[] fileIDs;  //an array of fileIDs, filled in ascending index order
...
///////////////
	...
	boolean isHeld, isValid, isClean, isFetching, isPushing, isPinned //various booleans for synchronizing the various methods that are called upon the DBuffer.  Self explanatory names, isPinned is when 
